          ...
          <div className="container">
            <div className="flex content-center">
              ...
              <div className="center flex grow">
                <div class="nav-category mr-3 content-center">
                  <svg
                ...
                <input
                  ref={input}
                  className="p-3 my-3 mx-1 rounded-md leading-3 grow"
                  type="text"
                  placeholder="Tìm trên Sendo"
                />
                <button
                  className="bg-white p-3 my-3 rounded-md leading-3"
